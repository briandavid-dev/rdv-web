...
var BtnAgregar = function BtnAgregar(props) {
  ...
  var onFinish = function onFinish(values) {
    console.log("values", JSON.stringify); // image_extension: fileCertificado[0][0].extension,
