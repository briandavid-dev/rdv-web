...
strings.quienes = {
  ...
  parrafo1: `El Ron de Venezuela es un producto que representa no sólo la
  ...
  parrafo2: `La industria ronera venezolana no sólo genera dividendos para la
  ...
  elfondo1: `El Fondo de Promoción del Ron de Venezuela FONPRONVEN se creó en
  ...
  elfondo2: `El Fondo estableció un Consejo Regulador que se encarga de
  ...
  tambien: `FONPRONVEN también se enfoca en crear conciencia en el público
  ...
  vision: `Visión`,
  vision1: `Que la Denominación de Origen Controlada sea la marca que
  ...
  Venezuela.`,
  valores: `Valores de la organización`,
  entusiasmo: `Entusiasmo:`,
  entusiasmo1: `A través del conocimiento,
  la constancia y la tecnología hemos sido capaces de alcanzar
  valores óptimos de calidad en el ron de Venezuela y se ha
  ...
  colaboracion1: `La institución busca unir esfuerzos y aportar lo mejor de cada
  ...
  parrafo1: (
    <>
      <p>
        ...
        <br />
        Domicilio Fiscal: Av. Libertador con Av. Alameda, Edif. Exa, piso PH 9,
        <br />
        oficina PH-09, Urb. El retiro, Edo. Miranda, Municipio Chacao, Caracas.
      </p>
    </>
  ),
  contacto: (
...
strings.empresas = {
  ...
  paraMayor: `Para mayor información vista:`,
};
